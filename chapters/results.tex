...
\begin{figure}[ht]
    ...
    \caption{Profilometerdata showing scan 1, 2, and 3.
        ...
        % TODO, kommentar (fikset, men les over):Is it possible to indicate where approximately in figure 3 these scans were taken?
        % Brynjar, nei, ikke egentlig, vi har jo ikke noe oversiktsbilde. Men foreslår:
        % blir kanskje litt upresist med "the length" men tror det er ok
