...
% TODO, kommentar: In general yes. However, different sol-gel routes can be quite different, and do not necessarily contain all the steps.
% Gammel setning:
...
% TODO: referanse til neste avsnitt
...
The barium nitrate and the titanium isopropoxide are the sources of the barium and titanium, respectively \cite{lab}. % ganske dårlig kilde men var jo den som vi brukte
...
% TODO, kommentar: Do you know what a typical probe tip size is?
% brynjar, jeg aner ikke. den vi brukte var radius=12.5
